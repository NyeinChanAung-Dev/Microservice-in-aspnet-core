...
/****** Object:  Database [Product_DB]    Script Date: 10/7/2021 3:09:25 PM ******/
CREATE DATABASE [Product_DB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Product_DB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Product_DB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Product_DB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Product_DB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Product_DB] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [Product_DB] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [Product_DB] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Product_DB] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Product_DB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [Product_DB] SET QUERY_STORE = OFF
GO
